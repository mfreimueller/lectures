# Kata 01: Notenverwaltung

Schreibe ein Programm zur Notenverwaltung mit folgenden Methoden:
...
```java
int[] noten = {3, 1, 4, 2, 5, 2, 3, 4};
// Ausgabe:
// Noten: [3, 1, 4, 2, 5, 2, 3, 4]
// Durchschnitt: 3.0
// Minimum: 1
// Maximum: 5
// Sortiert: [1, 2, 2, 3, 3, 4, 4, 5]
```
