...
2. Die Methode `einzahlen(double betrag)` erhoeht den Kontostand um den Betrag (nur positive Betraege erlaubt)
...
Erstelle eine Test-Klasse mit main-Methode, die ein Konto eroeffnet, ein- und auszahlt und den Kontostand anzeigt.
...
Auszahlung von 2000.0 nicht moeglich!
Kontostand: 1300.0
```
