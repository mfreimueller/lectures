...
<ul>
<li>Thymeleaf als Server-Side Template Engine</li>
<li>@Controller für View-Rendering</li>
<li>th:each, th:if, th:switch für Logik</li>
<li>th:object + th:field für Formulare</li>
<li>Fragment-Layouts mit th:replace</li>
</ul>
</div>
