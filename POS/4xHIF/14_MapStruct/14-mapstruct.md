...
- Warum DTOs wichtig sind (Sicherheit, Versionierung, Performance)
- MapStruct Setup mit Maven/Gradle
- @Mapper und automatisches Field-Matching
- @Mapping für Feld-Umbenennungen und Ignorieren
- Flattened vs. Nested Relationship Mapping
