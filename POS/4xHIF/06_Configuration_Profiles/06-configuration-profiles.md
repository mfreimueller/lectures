...
- Externalisierte Konfiguration mit application.yml / .properties
- @Value für einzelne Werte
- @ConfigurationProperties für typsichere Config-Klassen
- @Profile für umgebungsspezifische Beans
- Profile-spezifische Konfigurationsdateien und Aktivierung (CLI, Umgebungsvariablen)
