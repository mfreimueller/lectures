...
- RestClient als moderne Alternative zu RestTemplate
- GET, POST, PUT, DELETE mit RestClient
- Fehlerbehandlung mit onStatus
- Retry-Logik mit Spring Retry
- Timeouts und Connection-Pool-Konfiguration
