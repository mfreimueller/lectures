...
<ul>
<li>OpenAPI/Swagger als API-Dokumentationsstandard</li>
<li>springdoc-openapi Integration</li>
<li>Swagger UI Customization</li>
<li>Spring REST Docs (Test-getrieben)</li>
<li>REST Docs vs OpenAPI — Vergleich</li>
</ul>
</div>
