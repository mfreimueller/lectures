...
- Warum Schema-Migrationen notwendig sind
- Flyway: versionierte SQL-Dateien
- Namenskonvention V{Version}__{Beschreibung}.sql
- ddl-auto: validate statt update/create
- Checksum-Integrität und Repair
