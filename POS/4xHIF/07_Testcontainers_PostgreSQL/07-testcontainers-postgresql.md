...
- Warum H2 für JPA-Tests nicht ausreicht
- Testcontainers für PostgreSQL-Container in Tests
- @Container, @Testcontainers, @DynamicPropertySource
- Abstracte Test-Basisklasse für Wiederverwendung
- Integration mit Flyway
