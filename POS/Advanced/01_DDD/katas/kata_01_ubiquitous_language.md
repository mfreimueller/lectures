...
Sie arbeiten an einem System fur eine **Bibliothek**. Die Fachexperten verwenden folgende Begriffe:
...
- "Mahnung" — Eine Erinnerung an die Ruckgabe eines uberfalligen Mediums
- "Gebuhr" — Ein Geldbetrag, der fur verspatete Ruckgabe oder Verlust fallig wird

Erstellen Sie ein Ubiquitous Language Glossar mit:
...
Identifizieren Sie zusatzlich die Bounded Contexts der Bibliotheksdomane (z.B. Ausleihkontext, Katalogkontext, Mitgliederverwaltung).
