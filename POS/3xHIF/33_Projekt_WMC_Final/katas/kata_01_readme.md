...
3. Technology stack (Java, Servlets, JPA, PostgreSQL, etc.)
...
A REST API for managing a library, built with Java, Servlets, and JPA.

## Domain
Users can borrow books, write reviews, and manage their profile.

## Tech Stack
- Java 17, Servlets (Tomcat 10), Hibernate 6, PostgreSQL, JUnit 5, Mockito
