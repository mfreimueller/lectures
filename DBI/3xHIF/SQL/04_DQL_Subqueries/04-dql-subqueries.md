...
2. Rules for Subqueries
3. What Can a Subquery Return?
4. Scalar Subqueries
5. Multi-Value Subqueries
...
7. Subqueries in the FROM Clause (Derived Tables)
8. Subqueries with INSERT
9. Subqueries with UPDATE / DELETE
10. Preview: Correlated Subqueries
...
- I can explain what a subquery is and where it can appear in a SQL statement
- I can write scalar, multi-value (`IN`), and `EXISTS` subqueries
- I can use a subquery as a derived table in `FROM`
- I can use subqueries inside `INSERT`, `UPDATE`, and `DELETE` statements
- I know when a `JOIN` might be preferable to a subquery
