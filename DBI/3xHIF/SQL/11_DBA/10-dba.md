...
1. Why Database Administration Matters
2. Creating a User
3. The `%` Host Wildcard
4. Applying Privilege Changes
5. Dropping a User
6. Inspecting Users & Privileges
7. The GRANT Command
8. Privilege Types
...
9. Granting to Multiple Users / Multiple Privileges
10. Granting Database-Creation Rights
11. PUBLIC
12. WITH GRANT OPTION
13. Column-Level Privileges
14. Cross-Database Access
15. Revoking Privileges
16. Combining Views + GRANT for Column-Level Security

---

## Learning Goals

- I can create and drop MySQL users, including host-scoped and wildcard accounts
- I can grant and revoke privileges at the database, table, and column level
- I know the effect of `WITH GRANT OPTION` and `PUBLIC`
- I can combine views and `GRANT` for fine-grained, column-level security
