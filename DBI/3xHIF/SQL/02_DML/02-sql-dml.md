...
2. List of DML Commands
3. SQL INSERT INTO Statement
4. INSERT INTO ... Without Column Names
...
7. Common Mistake: UPDATE Without WHERE
8. SQL DELETE Statement
9. Common Mistake: DELETE Without WHERE
...
- I can insert single and multiple rows with `INSERT INTO`
- I can update existing rows safely with `UPDATE ... WHERE`
- I can delete rows safely with `DELETE ... WHERE`
- I know the difference between `DELETE` and `TRUNCATE`
